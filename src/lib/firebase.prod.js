...
const config = {
    apiKey: "AIzaSyAFeaXUWii_yL1uceKG0qyuWlkQPQ3ecCI",
    authDomain: "netflix-db0db.firebaseapp.com",
    projectId: "netflix-db0db",
    storageBucket: "netflix-db0db.appspot.com",
    messagingSenderId: "68722589783",
    appId: "1:68722589783:web:456b122c58ccb39da2a312"
};

const firebase = initializeApp(config);

/**
 *  Uncomment the code below only once and run to add data into firebase firestore
 */

// const db = getFirestore();
// const collSeries = collection(db, "series");
// const collFilms = collection(db, "films");
